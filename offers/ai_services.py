...
def analyze_meeting_text(text: str) -> str:
    ...
    """
    prompt = f"""
Tu es un coach carrière expert. Un étudiant t'a partagé ses notes après un entretien de stage.

Analyse ces notes et fournis :
1. Un résumé de ce qui s'est bien passé
2. Les points à améliorer
3. Des conseils concrets pour les prochains entretiens
4. Une évaluation générale (Excellent / Bien / À améliorer)

Réponds en français, de manière bienveillante et constructive.
